...
function renderGeofenceStatus(isInside, distance = 0) {
    ...
    if (isInside) {
        ...
        subtext.textContent = "Secure connection active. You are within the 22.5m campus zone.";
        ...
        subtext.textContent = "Warning: Attendance cannot be marked. Please move within 22.5m of boundary.";
